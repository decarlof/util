...
##################################### Inputs #########################################################################
file_name = '/local/data/2018-11/Jakes/EW50um75RH_1_0078.h5' # best center = 1273
output_name = '/local/data/2018-11/Jakes/EW50um75RH_1_0078/'

best_center = 1294
sino_start = 0; sino_end = 25 #sino_start = 0; sino_end = 2048
...
num_iter = 20 # for sirt-fbp or iterative methods1
nChunks = 25 # number of rows divided by the number of chunks must be an integer

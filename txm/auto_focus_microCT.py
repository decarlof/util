...
#variableDict = {'ScanMotorName': 'Focus_5X',
variableDict = {'ScanMotorName': 'Focus_10X',
...
def lens_scan():
	...
	Motor_Start_Pos = global_PVs[Motor_Name].get() - float(variableDict['rscan_range']/2)
	Motor_End_Pos = global_PVs[Motor_Name].get() + float(variableDict['rscan_range']/2)

...
FileName_Im1 = '/local/dataraid/2014_07/TXM_commissioning/test/rotation_axis_twicking/Pin_0deg.tif'
FileName_Im2 = '/local/dataraid/2014_07/TXM_commissioning/test/rotation_axis_twicking/Pin_180deg.tif'
